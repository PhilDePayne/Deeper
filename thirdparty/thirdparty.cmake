...
if((NOT ASSIMP_LIBRARY) OR (NOT ASSIMP_INCLUDE_DIR))
	...
	#set(BUILD_SHARED_LIBS OFF CACHE INTERNAL "Build package with shared libraries.") #tu
...
file(COPY "${THIRDPARTY_DIR}/dlls/assimp-vc143-mt.dll" DESTINATION "${EXECUTABLE_OUTPUT_PATH}")
file(COPY "${THIRDPARTY_DIR}/dlls/freetyped.dll" DESTINATION "${EXECUTABLE_OUTPUT_PATH}")
file(COPY "${THIRDPARTY_DIR}/dlls/freetype.dll" DESTINATION "${EXECUTABLE_OUTPUT_PATH}")