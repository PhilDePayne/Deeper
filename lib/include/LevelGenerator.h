...
public:
    ...
    void newGame(int height) {
        ...
        for(int i = 0; i < 3; i++) {
            ...
            walls[num[i]][0].transform.position = glm::vec3(0.0f, pos[i] - 10.0f, 0.0f);
            walls[num[i]][1].transform.position = glm::vec3(0.0f, pos[i] - 10.0f, 0.0f);

            floors[num[i]].transform.position = glm::vec3(0.0f, pos[i] - 10.0f, 0.0f);
